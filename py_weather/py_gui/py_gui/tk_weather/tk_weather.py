...
from py_weather_lib import WeatherConfig, create as create_rust_bindings
...
from ..domain import Location, WeatherConfigException, WeatherData
...
class TkWeather:
    ...
    def _add_location(self):
        if not AddLocation(self._tk, Location(), self._config.as_weather_data()).is_cancelled():
            self._notebook.refresh()
...
class _Config(WeatherData):
    ...
    def init_bindings(self):
        ...
        try:
            ...
            self._rust_bindings = create_rust_bindings(self._config)
