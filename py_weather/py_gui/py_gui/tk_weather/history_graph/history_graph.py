...
class HistoryGraph(WeatherView):
    ...
    def __init__(self, parent, locations: Union[Location, List[Location]], weather_data: WeatherData,
                 add_tab: Callable[[str, WeatherView], None], date_range: Optional[DateRange] = None):
        self._parent = parent
