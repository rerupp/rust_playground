...
from ...domain import DateRange, LocationHistoryDates
...
class GraphSelection:
    ...
    def __init__(self, date_range: DateRange, primary_location=0, graph_type=GraphType.UNKNOWN,
...
class GraphSelector(Dialog):
    ...
    def __init__(self, parent, graph_selection: GraphSelection, locations_history_dates: List[LocationHistoryDates]):
