...
from ...domain import DailyHistories
...
class Graphs:
    ...
    def temperatures(self, temperature_type: TemperaturesType,
                     locations_daily_histories: List[DailyHistories]) -> plt.Figure:
    ...
    def conditions(self, condition_type: ConditionsType, locations_daily_histories: List[DailyHistories]) -> plt.Figure:
        """Creates the conditions graph."""
        return ConditionsGraph(condition_type, locations_daily_histories, self._font_size).figure


def _get_plot_dates(daily_histories: DailyHistories) -> List[date]:
...
class TemperatureGraph(BaseGraph):
    def __init__(self, temperature_type: TemperaturesType, locations_daily_histories: List[DailyHistories],
                 font_size: FontSize):
        """Creates the temperatures history graph."""
...
class PrecipitationGraph(BaseGraph):
    ...
    def __init__(self, precipitation_type: PrecipitationType, locations_daily_histories: List[DailyHistories],
                 font_size: FontSize):
...
class ConditionsGraph(BaseGraph):
    ...
    def __init__(self, conditions_type: ConditionsType, locations_daily_histories: List[DailyHistories],
                 font_size: FontSize):
