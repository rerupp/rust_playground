...
class HistoryReport(WeatherView):
    def __init__(self, parent, location_alias: str, weather_data: WeatherData, date_range: Optional[DateRange] = None):
...
class ReportSelection:
    def __init__(self, date_range: DateRange, temperatures=False, conditions=False, precipitation=False, summary=False,
                 full=False):
...
class ReportSelector(Dialog):
    def __init__(self, parent, location_history_dates: LocationHistoryDates, report_selection: ReportSelection):
...
def _create_contents(daily_histories: DailyHistories, report_selection: ReportSelection) -> List[Row]:
